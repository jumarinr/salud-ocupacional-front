    ...
    <b-navbar toggleable="lg" class="fixed-top bg-white">
      ...
      <b-collapse id="nav-collapse" is-nav>
        <b-navbar-nav pills class="ml-auto">
          ...
          <b-nav-item-dropdown right text="Informes" v-if="areaTrabajo() == 'Direccion'" exact exact-active-class="active"> 
            ...
            <b-dropdown-item href="#" to ="/informes/vacunas/costos">Costos de vacunación</b-dropdown-item>
          </b-nav-item-dropdown>           
